...
def _build_horoscope_prompt(day_configs: list[dict[str, str]]) -> str:
    ...
    return (
        ...
        f"Instead of astrology tropes, describe their day using purely mundane, random objects (cold coffee, Wi-Fi signals, broken zippers, IKEA furniture, tax reports, missed alarms). "
