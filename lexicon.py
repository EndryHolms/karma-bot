...
LEXICON = {
    "uk": {
        ...
        "menu_matrix": "🔮 Матриця Долі (Безкоштовно)",
        "menu_profile": "👤 Моя карма (баланс)",
        "btn_back": "🔙 Назад в меню",
        "btn_close": "❌ Закрити",
        "matrix_btn_finance": "💰 Фінансовий канал (50 ⭐️)",
        "matrix_btn_love": "❤️ Канал стосунків (50 ⭐️)",
        "matrix_intro_saved": "🔮 <b>Матриця Долі</b>\n\nЯ пам'ятаю вашу дату народження: <b>{dob}</b>.\nНатисніть кнопку нижче, щоб швидко розрахувати Матрицю, або просто введіть нову дату у форматі <b>ДД.ММ.РРРР</b>:",
        "matrix_intro": "🔮 <b>Матриця Долі</b>\n\nВведіть вашу дату народження у форматі <b>ДД.ММ.РРРР</b> (наприклад, 15.05.1995):",
        "matrix_invalid_date": "⚠️ Неправильний формат дати. Будь ласка, використовуйте формат <b>ДД.ММ.РРРР</b> (наприклад, 15.05.1995).",
        "matrix_processing": "✨ Розраховую аркани та малюю вашу Матрицю...",
        "matrix_upsell_processing": "✨ Занурююсь у глибини вашої Матриці...",
        "matrix_data_lost_alert": "⏳ Дані втрачено (час очікування вийшов). Будь ласка, почніть розрахунок Матриці спочатку.",
        "matrix_payment_success_data_lost": "Оплата успішна, але дані Матриці втрачено. Зробіть базовий розрахунок ще раз у меню.",
        "matrix_desc_finance": "Фінансовий канал Матриці",
        "matrix_desc_love": "Канал стосунків Матриці",
        "matrix_topic_finance": "ФІНАНСОВОГО КАНАЛУ (гроші, професія, блоки)",
        "matrix_topic_love": "КАНАЛУ СТОСУНКІВ (кохання, ідеальний партнер, блоки)",
        "matrix_limit_foreign": "🚫 <b>Ліміт вичерпано</b>\n\nТи вичерпав ліміт безкоштовних розрахунків для інших дат. Ти можеш відкрити нову дату за 15 ⭐️ або запросити друга за реферальним посиланням (+1 спроба за друга).",
        "matrix_limit_own": "🧘‍♀️ Енергетика твоєї особистої Матриці зараз стабільна.\n\nНаступне безкоштовне оновлення прогнозу для цієї дати буде доступне через пару днів!",
        "matrix_buy_slot_btn": "🔓 Відкрити слот (15 ⭐️)",
        "matrix_slot_title": "Відкрити нову дату",
        "matrix_slot_desc": "Купити 1 додатковий слот для розрахунку нової Матриці",
        ...
        "error_energy_flows": "⏳ Почекай, енергія ще формується. Дочекайся завершення попередньої дії.",
        "service_temporarily_unavailable": "Сервіс тимчасово недоступний. Спробуй ще раз трохи пізніше.",
    ...
    "en": {
        ...
        "menu_matrix": "🔮 Matrix of Destiny (Free)",
        "menu_profile": "👤 My Karma (Balance)",
        "btn_back": "🔙 Back to Menu",
        "btn_close": "❌ Close",
        "matrix_btn_finance": "💰 Financial Channel (50 ⭐️)",
        "matrix_btn_love": "❤️ Relationship Channel (50 ⭐️)",
        "matrix_intro_saved": "🔮 <b>Matrix of Destiny</b>\n\nI remember your date of birth: <b>{dob}</b>.\nClick the button below to quickly calculate the Matrix, or just enter a new date in the format <b>DD.MM.YYYY</b>:",
        "matrix_intro": "🔮 <b>Matrix of Destiny</b>\n\nEnter your date of birth in the format <b>DD.MM.YYYY</b> (for example, 15.05.1995):",
        "matrix_invalid_date": "⚠️ Invalid date format. Please use the format <b>DD.MM.YYYY</b> (for example, 15.05.1995).",
        "matrix_processing": "✨ Calculating arcanas and drawing your Matrix...",
        "matrix_upsell_processing": "✨ Diving into the depths of your Matrix...",
        "matrix_data_lost_alert": "⏳ Data lost (timeout). Please start the Matrix calculation again.",
        "matrix_payment_success_data_lost": "Payment successful, but Matrix data is lost. Please do the basic calculation again from the menu.",
        "matrix_desc_finance": "Financial channel of the Matrix",
        "matrix_desc_love": "Relationship channel of the Matrix",
        "matrix_topic_finance": "FINANCIAL CHANNEL (money, profession, blocks)",
        "matrix_topic_love": "RELATIONSHIP CHANNEL (love, ideal partner, blocks)",
        "matrix_limit_foreign": "🚫 <b>Limit reached</b>\n\nYou have exhausted your free calculation limit for foreign dates. You can unlock a new date for 15 ⭐️ or invite a friend via referral link (+1 attempt per friend).",
        "matrix_limit_own": "🧘‍♀️ The energy of your personal Matrix is stable now.\n\nThe next free forecast update for this date will be available in a couple of days!",
        "matrix_buy_slot_btn": "🔓 Unlock slot (15 ⭐️)",
        "matrix_slot_title": "Unlock a new date",
        "matrix_slot_desc": "Buy 1 additional slot to calculate a new Matrix",
        "choose_language": "🇺🇦 Оберіть мову:\n🇬🇧 Choose your language:\n🇷🇺 Выберите язык:",
        ...
        "error_generate": "Sorry, energy flows are unstable right now. Please try again later.",
        "error_energy_flows": "⏳ Wait, the energy is still forming. Please wait for the previous action to finish.",
        "service_temporarily_unavailable": "Service is temporarily unavailable. Please try again a bit later.",
        "more_action_btn": "💫 Feel like this isn't all? Choose the next action 👇",
    ...
    "ru": {
        ...
        "menu_matrix": "🔮 Матрица Судьбы (Бесплатно)",
        "menu_profile": "👤 Моя карма (баланс)",
        "btn_back": "🔙 Назад в меню",
        "btn_close": "❌ Закрыть",
        "matrix_btn_finance": "💰 Финансовый канал (50 ⭐️)",
        "matrix_btn_love": "❤️ Канал отношений (50 ⭐️)",
        "matrix_intro_saved": "🔮 <b>Матрица Судьбы</b>\n\nЯ помню вашу дату рождения: <b>{dob}</b>.\nНажмите кнопку ниже, чтобы быстро рассчитать Матрицу, или просто введите новую дату в формате <b>ДД.ММ.ГГГГ</b>:",
        "matrix_intro": "🔮 <b>Матрица Судьбы</b>\n\nВведите вашу дату рождения в формате <b>ДД.ММ.ГГГГ</b> (например, 15.05.1995):",
        "matrix_invalid_date": "⚠️ Неверный формат даты. Пожалуйста, используйте формат <b>ДД.ММ.ГГГГ</b> (например, 15.05.1995).",
        "matrix_processing": "✨ Рассчитываю арканы и рисую вашу Матрицу...",
        "matrix_upsell_processing": "✨ Погружаюсь в глубины вашей Матрицы...",
        "matrix_data_lost_alert": "⏳ Данные потеряны (время ожидания вышло). Пожалуйста, начните расчет Матрицы сначала.",
        "matrix_payment_success_data_lost": "Оплата успешна, но данные Матрицы потеряны. Сделайте базовый расчет еще раз в меню.",
        "matrix_desc_finance": "Финансовый канал Матрицы",
        "matrix_desc_love": "Канал отношений Матрицы",
        "matrix_topic_finance": "ФИНАНСОВОГО КАНАЛА (деньги, профессия, блоки)",
        "matrix_topic_love": "КАНАЛА ОТНОШЕНИЙ (любовь, идеальный партнер, блоки)",
        "matrix_limit_foreign": "🚫 <b>Лимит исчерпан</b>\n\nТы исчерпал лимит бесплатных расчетов для других дат. Ты можешь открыть новую дату за 15 ⭐️ или пригласить друга по реферальной ссылке (+1 попытка за друга).",
        "matrix_limit_own": "🧘‍♀️ Энергетика твоей личной Матрицы сейчас стабильна.\n\nСледующее бесплатное обновление прогноза для этой даты будет доступно через пару дней!",
        "matrix_buy_slot_btn": "🔓 Открыть слот (15 ⭐️)",
        "matrix_slot_title": "Открыть новую дату",
        "matrix_slot_desc": "Купить 1 дополнительный слот для расчета новой Матрицы",
        "choose_language": "🇺🇦 Оберіть мову:\n🇬🇧 Choose your language:\n🇷🇺 Выберите язык:",
        ...
        "error_generate": "Прости, энергетические потоки сейчас нестабильны. Попробуй еще раз позже.",
        "error_energy_flows": "⏳ Подожди, энергия еще формируется. Дождись завершения предыдущего действия.",
        "service_temporarily_unavailable": "Сервис временно недоступен. Попробуй еще раз чуть позже.",
